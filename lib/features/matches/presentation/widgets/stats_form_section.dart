...
class StatsFormSection extends StatelessWidget {
  ...
  static const List<_StatField> _fields = [
    ...
    _StatField('rematesAlArco',    'Al arco',             Icons.gps_fixed_rounded,             AppColors.success),
    _StatField('pasesCompletados', 'Pases completados',   Icons.check_circle_outline_rounded,  AppColors.success),
    _StatField('pasesFallidos',    'Pases fallidos',      Icons.cancel_outlined,               AppColors.danger),
